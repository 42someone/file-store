...
exports.GetOneFileUseCaseImpl = void 0;
...
let GetOneFileUseCaseImpl = class GetOneFileUseCaseImpl {
    ...
    execute(params) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const foundFile = yield this.fileRepository.findByID(params.id);
            if (!foundFile) {
...
exports.GetOneFileUseCaseImpl = GetOneFileUseCaseImpl;
exports.GetOneFileUseCaseImpl = GetOneFileUseCaseImpl = tslib_1.__decorate([
